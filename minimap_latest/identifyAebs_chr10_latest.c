...
//								pr1[0].fR.qual = mapQ_1;
								if ((pr2[i].contig == pr1[0].contig) && (abs (pr2[i].rs - pr1[0].rs) < posDiff) && (pr2[i].strand != pr1[0].strand) && (pr2[i].score >= (pr2[i].readLen -4*4)) && (posDiff > 300) && ((posDiff == 100000) || ((pr2[i1].score-pr2[i].score) <= 2*4)))
								{
...
//									if (posDiff < 300) break;
							...
							if (posDiff < 100000)
							{
								if (i1==0)
								{
									...
									{
										if ((pr2[i-1].rs != pr2[i].rs) && (pr2[i].contig == pr1[0].contig) && (pr2[i].strand != pr1[0].strand) && (abs (abs (pr2[i].rs - pr1[0].rs) - abs(pr2[i1].rs - pr1[0].rs)) < sub2PosDiff) && ((sub2PosDiff == 100000) || (pr2[i].score >= (pr2[i].readLen -10*4))))
										{
											sub2Ind = i;
...
//								if (pr1[0].fR.qual > 0)
								{
//									printf ("1-%d,%s/1,%d,%s,%s,%d,%d,%c,%d,%d,%d,%d - NM:%d,MQ:%u\n", pr1[0].readId, pr1[0].readName, pr1[0].readLen, pr1[0].seq, pr1[0].qual, pr1[0].qs, pr1[0].qe, pr1[0].strand, pr1[0].contig, pr1[0].contigLen, pr1[0].rs, pr1[0].re, pr1[0].score, pr1[0].fR.qual);
								}
								fwrite (&(pr2[i].fR), sizeof(fullRec), 1, fpAeb);
//								if (pr2[i].fR.qual > 0)
								{
//									if (i!=0) printf ("*");
//									printf ("2-%d,%s/2,%d,%s,%s,%d,%d,%c,%d,%d,%d,%d - NM:%d,MQ:%u\n", pr2[i].readId, pr2[i].readName, pr2[i].readLen, pr2[i].seq, pr2[i].qual, pr2[i].qs, pr2[i].qe, pr2[i].strand, pr2[i].contig, pr2[i].contigLen, pr2[i].rs, pr2[i].re, pr2[i].score, pr2[i].fR.qual);
								}
							}
							else
							{
...
//							pr2[0].fR.qual = mapQ_2;
							for (i=0; i<pr1_n; i++)
							{
								if ((pr1[i].contig == pr2[0].contig) && (abs (pr1[i].rs - pr2[0].rs) < posDiff) && (pr1[i].strand != pr2[0].strand)  && (pr1[i].score >= (pr1[i].readLen -4*4)) && (posDiff > 300) && ((posDiff == 100000) || ((pr1[i1].score-pr1[i].score) <= 2*4)))
								{
...
//									if (posDiff < 300) break;
							...
							if (posDiff < 100000)
							{
								if (i1==0)
								{
									...
									{
										if ((pr1[i-1].rs != pr1[i].rs) && (pr1[i].contig == pr2[0].contig) && (pr1[i].strand != pr2[0].strand) && (abs (abs (pr1[i].rs - pr2[0].rs) - abs(pr1[i1].rs - pr2[0].rs)) < sub1PosDiff) && ((sub1PosDiff == 100000) || (pr1[i].score >= (pr1[i].readLen -10*4))))
										{
											sub1Ind = i;
...
//								if (pr1[i].fR.qual > 0)
								{
//									if (i!=0) printf ("*");
//									printf ("4-%d,%s/1,%d,%s,%s,%d,%d,%c,%d,%d,%d,%d - NM:%d,MQ:%u\n", pr1[i].readId, pr1[i].readName, pr1[i].readLen, pr1[i].seq, pr1[i].qual, pr1[i].qs, pr1[i].qe, pr1[i].strand, pr1[i].contig, pr1[i].contigLen, pr1[i].rs, pr1[i].re, pr1[i].score, pr1[i].fR.qual);
								}
								fwrite (&(pr2[0].fR), sizeof(fullRec), 1, fpAeb);
//								if (pr2[0].fR.qual > 0)
								{
//									printf ("6-%d,%s/2,%d,%s,%s,%d,%d,%c,%d,%d,%d,%d - NM:%d,MQ:%u\n", pr2[0].readId, pr2[0].readName, pr2[0].readLen, pr2[0].seq, pr2[0].qual, pr2[0].qs, pr2[0].qe, pr2[0].strand, pr2[0].contig, pr2[0].contigLen, pr2[0].rs, pr2[0].re, pr2[0].score, pr2[0].fR.qual);
								}
							}
							else
							{
