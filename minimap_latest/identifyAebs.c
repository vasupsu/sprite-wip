...
//	sprintf (fileName, "%s.aeb", pafFileName);
	FILE **fpAeb = (FILE **)calloc (numContigs, sizeof (FILE *));
	assert (fpAeb != NULL);
...
//								printf ("pr1[0].contig %d\n", pr1[0].contig);
								if (fpAeb[pr1[0].contig] == NULL)
								{
									sprintf (fileName, "%s_%d.aeb", pafFileName, pr1[0].contig);
									fpAeb[pr1[0].contig] = fopen (fileName, "w");
								}
								assert (fpAeb[pr1[0].contig] != NULL);
								fwrite (&(pr1[0].fR), sizeof(fullRec), 1, fpAeb[pr1[0].contig]);
//								if (pr1[0].fR.qual > 0)
//								if (pr1[0].contig == 17)
								{
								...
								if (fpAeb[pr2[i].contig] == NULL)
								{
									sprintf (fileName, "%s_%d.aeb", pafFileName, pr2[i].contig);
									fpAeb[pr2[i].contig] = fopen (fileName, "w");
								}
								assert (fpAeb[pr2[i].contig] != NULL);
								fwrite (&(pr2[i].fR), sizeof(fullRec), 1, fpAeb[pr2[i].contig]);
//								if (pr2[i].contig == 17)
//								if (pr2[i].fR.qual > 0)
								{
//									if (i!=0) printf ("*");
...
//										printf ("%d: %d %c %d, %d, %d\n", j, pr1[j].readId, pr1[j].strand, pr1[j].contig, pr1[j].rs, pr1[j].score);
								...
								i=i1;
								if (fpAeb[pr1[i].contig] == NULL)
								{
									sprintf (fileName, "%s_%d.aeb", pafFileName, pr1[i].contig);
									fpAeb[pr1[i].contig] = fopen (fileName, "w");
								}
								assert (fpAeb[pr1[i].contig] != NULL);
								fwrite (&(pr1[i].fR), sizeof(fullRec), 1, fpAeb[pr1[i].contig]);
//								if (pr1[i].fR.qual > 0)
//								if (pr1[i].contig == 17)
								{
//									if (i!=0) printf ("*");
								...
								if (fpAeb[pr2[0].contig] == NULL)
								{
									sprintf (fileName, "%s_%d.aeb", pafFileName, pr2[0].contig);
									fpAeb[pr2[0].contig] = fopen (fileName, "w");
								}
								assert (fpAeb[pr2[0].contig] != NULL);
								fwrite (&(pr2[0].fR), sizeof(fullRec), 1, fpAeb[pr2[0].contig]);
//								if (pr2[0].fR.qual > 0)
//								if (pr2[0].contig == 17)
								{
